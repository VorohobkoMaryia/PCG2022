...
namespace PKG_5
{
    public partial class Application : Form
    {
        public Application()
        {
            ...
            segmentsForLiangBarski = clipperSutherlandCohen("sutherlandcohen.txt");
        ...
        private void panel1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Pen outering = new Pen(Color.Black, shift / 4);
        ...
        public void clipperSegmentsSutherlandCohen(Graphics gr, Panel panel, Pen entering, Pen outering)
        {
            ...
            for (int i = 0; i < segmentsForLiangBarski.Count; i++)
            {
                ...
                if (algo.SutherlandCohen(segmentsForLiangBarski[i].Key, segmentsForLiangBarski[i].Value, ref p1, ref p2)) {
                    drawSegment(gr, panel, p1, p2, entering);
                }
            }
        }
        ...
        public void clipperSegmentsCyrusBeck(Graphics gr, Panel panel, Pen entering, Pen outering)
        {
            ...
            for (int i = 0; i < segmentsForCyrusBeck.Count; i++)
            {
                ...
                algo.CyrusBeck(segmentsForCyrusBeck[i].Key, segmentsForCyrusBeck[i].Value, ref t_1, ref t_2);
