...
void letter::getIndexArray()
{
    setQuad(0, 0, 1, 2, 3);
        ...
        setQuad(17, 3, 2, 27, 26);
        setQuad(18, 26, 3, 32, 28);
        setQuad(19, 28, 32, 33, 29);
        setQuad(20, 27, 2, 33, 29);

        setQuad(21, 28, 30, 36, 34);
        setQuad(22, 30, 31, 37, 36);
        setQuad(23, 31, 29, 35, 37);
        setQuad(24, 29, 28, 34, 35);

        setQuad(25, 36, 37, 35, 34);
}
